...
const SchoolYearScreenLazy = lazy(() => import(/* webpackChunkName: "SchoolYear" */'../../screens/admin/schoolYear/SchoolYearScreen'));
  ...
  const routesObject: RouteObject[] = [
    {
      ...
      children: [
        ...
        {
          element: <PermissionsGate fallback={fallback} module="schoolYear" permission="canView"><SchoolYearScreenLazy /></PermissionsGate>,
          path: 'schoolYear/',
        },
      ],
    },
