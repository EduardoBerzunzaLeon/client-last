...
import { subjectInHistoryFieldsTranslation, SubjectInHistoryFieldsTranslation } from '../translation';
...
export const setSubjectInHistoryFormErrors = handlerFormErrors<
