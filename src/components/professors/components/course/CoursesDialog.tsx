...
import { CalendarFilter } from '../../../datatable';
import { CourseDataForm } from './CourseDataForm';
import { ImpartedAtBodyTemplate, ActionsCoursesBodyTemplate } from '../columns';
import { initialFiltersCoursesValue } from '../../assets';
